...
Invoke-LiquidTemplate [-Template] <String> [-Context] <Hashtable> [[-Dialect] <String>]
 [[-IncludeRoot] <String>] [[-CurrentFilePath] <String>] [[-RelativeIncludeRoot] <String>]
 [[-IncludeStack] <String[]>] [[-Registry] <Hashtable>] [[-RenderDepth] <Int32>] [<CommonParameters>]
```
...
Built-in filters include string, numeric, date,
